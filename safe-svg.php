...
if ( ! class_exists( 'safeSvg' ) ) {
    ...
    Class safeSvg {
         ...
         * @return mixed
         */
        public function checkForSvg( $file ) {
         ...
         * @return string
         */
        public function featuredImageFix( $content, $post_id, $thumbnail_id ) {
        ...
        function loadCustomAdminStyle() {
            wp_enqueue_style( 'safe-svg-css', plugins_url( 'assets/safe-svg.css', __FILE__ ), [] );
        }
         ...
         * @return mixed
         */
        function getImageTagOverride( $html, $id, $alt, $title, $align, $size ) {
         ...
         */
        function metadataErrorFix( $data, $post_id ) {
         ...
         *                                 (in that order). Default 'thumbnail'.
         */
        public function fixDirectImageOutput( $attr, $attachment, $size = 'thumbnail' ) {
